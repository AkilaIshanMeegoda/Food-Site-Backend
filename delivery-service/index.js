...
// MongoDB connection
mongoose.connect(
  "mongodb+srv://foodApp:2001@cluster0.afkbz0b.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
);
...
app.post("/delivery-personnel", verifyDeliveryPersonnel, async (req, res) => {
  ...
  if (existingPersonnel) {
    return res
      .status(400)
      .json({ error: "You are already registered as delivery personnel" });
  }
